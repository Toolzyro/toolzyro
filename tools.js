/* ==========================================================
...

   {
     ...
     category: "Chat & Assistants", // must match one of the CATEGORIES below
   ...
   - To add a brand new category, add it to the CATEGORIES list
     below AND use that exact name in a tool's "category" field.
   ========================================================== */
